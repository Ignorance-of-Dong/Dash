/*
 * @Author: zhangzheng
 * @Date: 2025-09-25 18:53:47
 * @LastEditors: zhangzheng
 * @LastEditTime: 2025-09-25 18:57:57
 * @Description:
 */
...
export const isEnLocal = !["zh", "zh-cn", "zh-CN", "tw"].includes("zh");
...
const t = (a) => a;
export const DEFAULT_COLOR_CASE: DeepPartial<any> = {
  basicStyle: {
    colorScheme: "default",
    colors: [
      "#1E90FF",
...
export const DEFAULT_COLOR_CASE_LIGHT: DeepPartial<any> = {
  basicStyle: {
    colorScheme: "default",
    colors: [
      "#1E90FF",
...
export const DEFAULT_COLOR_CASE_DARK: DeepPartial<any> = {
  basicStyle: {
    colorScheme: "default",
    colors: [
      "#1E90FF",
...
export const DEFAULT_TOOLTIP: any = {
  show: true,
  trigger: "item",
  confine: true,
  fontSize: 12,
...
export const DEFAULT_TABLE_TOTAL: any = {
  row: {
...
export const DEFAULT_TABLE_HEADER: any = {
...
export const DEFAULT_TABLE_CELL: any = {
  tableFontColor: "#000000",
...
export const DEFAULT_TITLE_STYLE: any = {
  show: true,
  fontSize: 16,
  color: "#ffffff",
  hPosition: "left",
...
export const DEFAULT_INDICATOR_STYLE: any = {
  show: true,
  fontSize: 20,
  color: "#5470C6ff",
  hPosition: "center",
...
export const DEFAULT_INDICATOR_NAME_STYLE: any = {
  show: true,
  fontSize: 18,
  color: "#ffffffff",
  isItalic: false,
...
export const DEFAULT_TITLE_STYLE_BASE: any = {
  show: true,
  fontSize: 16,
  hPosition: "left",
  vPosition: "top",
...
export const DEFAULT_LEGEND_STYLE_BASE: any = {
  show: true,
  hPosition: "center",
  vPosition: "bottom",
  orient: "horizontal",
...
export const DEFAULT_LEGEND_STYLE: any = {
  show: true,
  hPosition: "center",
  vPosition: "bottom",
  orient: "horizontal",
...
export const DEFAULT_LEGEND_STYLE_LIGHT: any = {
  ...DEFAULT_LEGEND_STYLE_BASE,
  color: "#333333",
  fontSize: 12,
};

export const DEFAULT_LEGEND_STYLE_DARK: any = {
  ...DEFAULT_LEGEND_STYLE_BASE,
  color: "#ffffff",
  fontSize: 12,
};
...
export const DEFAULT_XAXIS_STYLE: any = {
  show: true,
  position: "bottom",
  nameShow: false,
  name: "",
...
export const DEFAULT_YAXIS_STYLE: any = {
  show: true,
  position: "left",
  nameShow: false,
  name: "",
...
export const DEFAULT_YAXIS_EXT_STYLE: any = {
  show: true,
  position: "right",
  name: "",
  color: "#333333",
...
export const DEFAULT_MISC_STYLE: any = {
  showName: false,
  color: "#999",
  fontSize: 12,
  axisColor: "#999",
...
export const DEFAULT_FUNCTION_CFG: any = {
  sliderShow: false,
  sliderRange: [0, 10],
  sliderBg: "#FFFFFF",
  sliderFillBg: "#BCD6F1",
...
export const DEFAULT_ASSIST_LINE_CFG: any = {
  enable: false,
  assistLine: [],
};
export const DEFAULT_THRESHOLD: any = {
  enable: false,
  gaugeThreshold: "",
  liquidThreshold: "",
  labelThreshold: [],
...
export const DEFAULT_SCROLL: any = {
  open: false,
  row: 1,
  interval: 2000,
  step: 50,
...
export const DEFAULT_BUBBLE_ANIMATE: any = {
  enable: false,
  speed: 1,
  rings: 1,
  type: "wave",
...
export const DEFAULT_QUADRANT_STYLE: any = {
  lineStyle: {
    stroke: "#aaa",
    lineWidth: 1,
    opacity: 0.5,
...
export const CHART_FONT_FAMILY_ORIGIN = [
  ...
  {
    name: t("chart.font_family_song_ti"),
    value: 'SimSun, "Songti SC", STSong',
  },
...
export const DEFAULT_BASIC_STYLE: any = {
  alpha: 100,
  tableBorderColor: "#CCCCCC",
  ...
  CHART_TYPE_CONFIGS.forEach((category) => {
    category.details.forEach((viewConfig) => {
      if (viewConfig.value === name) {
        viewConfigResult = clone(viewConfig);
      }
    });
  });
